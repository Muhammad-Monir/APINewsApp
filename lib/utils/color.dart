...
const Color loginWelcomeColor = Color(0xFF545454);
const Color appBarColor = Color(0xFF000000);
const Color feedbackColor = Color(0xFF3C4B62);
const Color dividerColor = Color(0xFFD8D9DC);
const Color tabBarDividerColor = Color(0xFF4E617E);
const Color categoryColor = Color(0xFFEBF3FF);
