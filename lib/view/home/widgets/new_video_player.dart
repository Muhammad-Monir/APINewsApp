...
class NewsVideoPlayer extends StatefulWidget {
  ...
  const NewsVideoPlayer({super.key});
...
class _NewsVideoPlayerState extends State<NewsVideoPlayer> {
  ...
  // final t =
  // 'https://192.168.40.38/Am_inn/public/uploads/meme_videos/asdgasdg-bz3tyg76nd1hbpv6wsugcqajascenm.mp4';
  @override
  void initState() {
    ...
    try {
      _videoPlayerController =
          ...
          VideoPlayerController.networkUrl(Uri.parse(t))
