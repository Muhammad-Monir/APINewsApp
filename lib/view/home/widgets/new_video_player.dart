...
class NewsVideoPlayerState extends State<NewsVideoPlayer> {
  ...
  void initState() {
    ...
    videoControllerProvider
        .initializeVideo('${ApiUrl.imageBaseUrl}${widget.t}');
    WakelockPlus.enable();
  }

  Widget _buildCustomControls(VideoControllerProvider videoControllerProvider) {
    return Padding(
      ...
      child: Column(
        ...
        children: [
          VideoProgressIndicator(
            videoControllerProvider.videoPlayerController,
            allowScrubbing: true,
          ...
          // Custom Controll's (Play Button)
          // Row(
          //   mainAxisSize: MainAxisSize.min,
          //   children: [
          //     IconButton(
          //       onPressed: () {
          //         if (videoControllerProvider.chewieController == null) return;
          //         if (videoControllerProvider.chewieController!.isPlaying) {
          //           videoControllerProvider.chewieController?.pause();
          //         } else {
          //           videoControllerProvider.chewieController?.play();
          //         }
          //       },
          //       icon: Icon(
          //         videoControllerProvider.chewieController?.isPlaying ?? false
          //             ? Icons.pause
  ...
  Widget build(BuildContext context) {
    return Consumer<VideoControllerProvider>(
      builder: (context, videoControllerProvider, child) {
        if (videoControllerProvider.chewieController == null) {
          ...
          child: Stack(
            ...
            children: [
              Positioned(
                ...
                top: 0,
                child: Chewie(
                    controller: videoControllerProvider.chewieController!),
              ),
              Padding(
                padding: const EdgeInsets.symmetric(horizontal: 8.0),
                child: _buildCustomControls(videoControllerProvider),
              ),
            ],
          ),
        );
