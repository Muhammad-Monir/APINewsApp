          ...
          Stack(
            ...
            children: [
              ...
              Positioned(
                ...
                child: Container(
                  padding:
                      EdgeInsets.symmetric(horizontal: Utils.scrHeight * .005),
                  ...
                  decoration: ShapeDecoration(
                    ...
                    shape: RoundedRectangleBorder(
                      side:
                          const BorderSide(width: 1, color: redContainerColor),
  ...
  Widget build(BuildContext context) {
    return Row(
      children: [
        ...
        SizedBox(
          width: Utils.scrHeight * .006,
        ),
        Text(
          'Home',
          style: regularTS(homeTabTextColor, fontSize: 15),
        )
      ],
    );
  }
